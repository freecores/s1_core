...
`else
`ifdef FPGA_SYN
   reg [33:0]     icdata_ary_00_00  [255:0];
   reg [33:0]     icdata_ary_00_01  [255:0];
   reg [33:0]     icdata_ary_00_10  [255:0];
   reg [33:0]     icdata_ary_00_11  [255:0];
   reg [33:0]     icdata_ary_01_00  [255:0];
   reg [33:0]     icdata_ary_01_01  [255:0];
   reg [33:0]     icdata_ary_01_10  [255:0];
   reg [33:0]     icdata_ary_01_11  [255:0];
   reg [33:0]     icdata_ary_10_00  [255:0];
   reg [33:0]     icdata_ary_10_01  [255:0];
   reg [33:0]     icdata_ary_10_10  [255:0];
   reg [33:0]     icdata_ary_10_11  [255:0];
   reg [33:0]     icdata_ary_11_00  [255:0];
   reg [33:0]     icdata_ary_11_01  [255:0];
   reg [33:0]     icdata_ary_11_10  [255:0];
   reg [33:0]     icdata_ary_11_11  [255:0];
`else
          ...
          begin
             if (wrreq_f)  // rd-wr contention
               begin
	             ...
	             begin  // regular read
`ifdef FPGA_SYN
			if(index_f[3:2] == 2'b00) begin
				fetdata_f[33:0]    = icdata_ary_00_00[index_f[11:4]];
				fetdata_f[67:34]   = icdata_ary_00_01[index_f[11:4]];
				fetdata_f[101:68]  = icdata_ary_00_10[index_f[11:4]];
				fetdata_f[135:102] = icdata_ary_00_11[index_f[11:4]];
			end
			if(index_f[3:2] == 2'b01) begin
				fetdata_f[33:0]    = icdata_ary_01_00[index_f[11:4]];
				fetdata_f[67:34]   = icdata_ary_01_01[index_f[11:4]];
				fetdata_f[101:68]  = icdata_ary_01_10[index_f[11:4]];
				fetdata_f[135:102] = icdata_ary_01_11[index_f[11:4]];
			end
			if(index_f[3:2] == 2'b10) begin
				fetdata_f[33:0]    = icdata_ary_10_00[index_f[11:4]];
				fetdata_f[67:34]   = icdata_ary_10_01[index_f[11:4]];
				fetdata_f[101:68]  = icdata_ary_10_10[index_f[11:4]];
				fetdata_f[135:102] = icdata_ary_10_11[index_f[11:4]];
			end
			if(index_f[3:2] == 2'b11) begin
				fetdata_f[33:0]    = icdata_ary_11_00[index_f[11:4]];
				fetdata_f[67:34]   = icdata_ary_11_01[index_f[11:4]];
				fetdata_f[101:68]  = icdata_ary_11_10[index_f[11:4]];
				fetdata_f[135:102] = icdata_ary_11_11[index_f[11:4]];
			end
`else 
...
`ifdef FPGA_SYN
			//top_index[2] == 1'b1;
			if(top_index[3] == 1'b0) begin
				topdata_f[33:0]    = icdata_ary_01_00[top_index[11:4]];
				topdata_f[67:34]   = icdata_ary_01_01[top_index[11:4]];
				topdata_f[101:68]  = icdata_ary_01_10[top_index[11:4]];
				topdata_f[135:102] = icdata_ary_01_11[top_index[11:4]];
			end
			if(top_index[3] == 1'b1) begin
				topdata_f[33:0]    = icdata_ary_11_00[top_index[11:4]];
				topdata_f[67:34]   = icdata_ary_11_01[top_index[11:4]];
				topdata_f[101:68]  = icdata_ary_11_10[top_index[11:4]];
				topdata_f[135:102] = icdata_ary_11_11[top_index[11:4]];
			end
`else
...
`ifdef FPGA_SYN
		   if (worden_f[0]) begin
		     if(wr_index0[1:0] == 2'b00) icdata_ary_00_00[wr_index0[11:4]] <= wrdata_f[135:102];
		     if(wr_index0[1:0] == 2'b01) icdata_ary_00_01[wr_index0[11:4]] <= wrdata_f[135:102];
		     if(wr_index0[1:0] == 2'b10) icdata_ary_00_10[wr_index0[11:4]] <= wrdata_f[135:102];
		     if(wr_index0[1:0] == 2'b11) icdata_ary_00_11[wr_index0[11:4]] <= wrdata_f[135:102];
		   end
		   if (worden_f[1]) begin
		     if(wr_index1[1:0] == 2'b00) icdata_ary_01_00[wr_index1[11:4]] <= wrdata_f[101:68];
		     if(wr_index1[1:0] == 2'b01) icdata_ary_01_01[wr_index1[11:4]] <= wrdata_f[101:68];
		     if(wr_index1[1:0] == 2'b10) icdata_ary_01_10[wr_index1[11:4]] <= wrdata_f[101:68];
		     if(wr_index1[1:0] == 2'b11) icdata_ary_01_11[wr_index1[11:4]] <= wrdata_f[101:68];
		   end
		   if (worden_f[2]) begin
		     if(wr_index2[1:0] == 2'b00) icdata_ary_10_00[wr_index2[11:4]] <= wrdata_f[67:34];
		     if(wr_index2[1:0] == 2'b01) icdata_ary_10_01[wr_index2[11:4]] <= wrdata_f[67:34];
		     if(wr_index2[1:0] == 2'b10) icdata_ary_10_10[wr_index2[11:4]] <= wrdata_f[67:34];
		     if(wr_index2[1:0] == 2'b11) icdata_ary_10_11[wr_index2[11:4]] <= wrdata_f[67:34];
		   end
		   if (worden_f[3]) begin
		     if(wr_index3[1:0] == 2'b00) icdata_ary_11_00[wr_index3[11:4]] <= wrdata_f[33:0];
		     if(wr_index3[1:0] == 2'b01) icdata_ary_11_01[wr_index3[11:4]] <= wrdata_f[33:0];
		     if(wr_index3[1:0] == 2'b10) icdata_ary_11_10[wr_index3[11:4]] <= wrdata_f[33:0];
		     if(wr_index3[1:0] == 2'b11) icdata_ary_11_11[wr_index3[11:4]] <= wrdata_f[33:0];
		   end
`else
	           if (worden_f[0]) 
