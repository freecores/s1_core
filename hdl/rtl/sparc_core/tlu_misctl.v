...
dff #(`TSA_CCR_WIDTH) dff_tsa0_ccr_m (
...
dff #(`TSA_CWP_WIDTH) dff_tsa0_cwp_m (
...
dff #(`TLU_ASI_STATE_WIDTH) dff_lsu_asi_m (
...
dff #(`TSA_PSTATE_WIDTH) dff_tsa0_pstate_m (
...
dff #(`TSA_GLOBAL_WIDTH) dff_tsa0_gl_m (
...
dff #(`TSA_TTYPE_WIDTH) dff_tsa1_ttype_m (
...
dff #(`TSA_HTSTATE_WIDTH) dff_tsa1_htstate_m (
...
dff #(`TLU_THRD_NUM) dff_thrd_sel_m (
