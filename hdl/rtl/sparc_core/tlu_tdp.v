...
dff #(`TLU_ASI_STATE_WIDTH) dff_imm_asi_e (
...
// Thread 0
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_HTBA_WIDTH) dff_true_htba0 (
...
`else
dff #(`TLU_HTBA_WIDTH) dff_true_htba0 (
    .din (tlu_wsr_data_w[`TLU_HTBA_HI:`TLU_HTBA_LO]), 
    .q   (true_htba0[`TLU_HTBA_WIDTH-1:0]),
    .clk (htba0_clk),
    .se  (se),       
...
// Thread 1
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_HTBA_WIDTH) dff_true_htba1 (
    .din (tlu_wsr_data_w[`TLU_HTBA_HI:`TLU_HTBA_LO]), 
...
`else
dff #(`TLU_HTBA_WIDTH) dff_true_htba1 (
    .din (tlu_wsr_data_w[`TLU_HTBA_HI:`TLU_HTBA_LO]), 
    .q   (true_htba1[`TLU_HTBA_WIDTH-1:0]),
    .clk (htba1_clk),
    .se  (se),       
...
// Thread 2
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_HTBA_WIDTH) dff_true_htba2 (
    .din (tlu_wsr_data_w[`TLU_HTBA_HI:`TLU_HTBA_LO]), 
...
`else
dff #(`TLU_HTBA_WIDTH) dff_true_htba2 (
    .din (tlu_wsr_data_w[`TLU_HTBA_HI:`TLU_HTBA_LO]), 
    .q   (true_htba2[`TLU_HTBA_WIDTH-1:0]),
    .clk (htba2_clk),
    .se  (se),       
...
// Thread 3
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_HTBA_WIDTH) dff_true_htba3 (
    .din (tlu_wsr_data_w[`TLU_HTBA_HI:`TLU_HTBA_LO]), 
...
`else
dff #(`TLU_HTBA_WIDTH) dff_true_htba3 (
    .din (tlu_wsr_data_w[`TLU_HTBA_HI:`TLU_HTBA_LO]), 
    .q   (true_htba3[`TLU_HTBA_WIDTH-1:0]),
    .clk (htba3_clk),
    .se  (se),       
...
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_ASR_DATA_WIDTH-1) tickcmp0 (
...
`else
dff #(`TLU_ASR_DATA_WIDTH-1) tickcmp0 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
	.q   (true_tickcmp0[`TLU_ASR_DATA_WIDTH-2:0]),
    .clk (tcmp0_clk),
    .se  (se),       
...
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_ASR_DATA_WIDTH-1) tickcmp1 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
...
`else
dff #(`TLU_ASR_DATA_WIDTH-1) tickcmp1 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
	.q   (true_tickcmp1[`TLU_ASR_DATA_WIDTH-2:0]),
    .clk (tcmp1_clk),
    .se  (se),       
...
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_ASR_DATA_WIDTH-1) tickcmp2 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
...
`else
dff #(`TLU_ASR_DATA_WIDTH-1) tickcmp2 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
	.q   (true_tickcmp2[`TLU_ASR_DATA_WIDTH-2:0]),
    .clk (tcmp2_clk),
    .se  (se),       
...
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_ASR_DATA_WIDTH-1) tickcmp3 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
...
`else
dff #(`TLU_ASR_DATA_WIDTH-1) tickcmp3 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
	.q   (true_tickcmp3[`TLU_ASR_DATA_WIDTH-2:0]),
    .clk (tcmp3_clk),
    .se  (se),       
...
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_ASR_DATA_WIDTH-1) stickcmp0 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
...
`else
dff #(`TLU_ASR_DATA_WIDTH-1) stickcmp0 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
	.q   (true_stickcmp0[`TLU_ASR_DATA_WIDTH-2:0]),
    .clk (stcmp0_clk),
    .se  (se),       
...
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_ASR_DATA_WIDTH-1) stickcmp1 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
...
`else
dff #(`TLU_ASR_DATA_WIDTH-1) stickcmp1 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
	.q   (true_stickcmp1[`TLU_ASR_DATA_WIDTH-2:0]),
    .clk (stcmp1_clk),
    .se  (se),       
...
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_ASR_DATA_WIDTH-1) stickcmp2 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
...
`else
dff #(`TLU_ASR_DATA_WIDTH-1) stickcmp2 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
	.q   (true_stickcmp2[`TLU_ASR_DATA_WIDTH-2:0]),
    .clk (stcmp2_clk),
    .se  (se),       
...
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_ASR_DATA_WIDTH-1) stickcmp3 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
...
`else
dff #(`TLU_ASR_DATA_WIDTH-1) stickcmp3 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
	.q   (true_stickcmp3[`TLU_ASR_DATA_WIDTH-2:0]),
    .clk (stcmp3_clk),
    .se  (se),       
...
// THREAD0
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_ASR_DATA_WIDTH-1) htickcmp0 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
...
`else
dff #(`TLU_ASR_DATA_WIDTH-1) htickcmp0 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
	.q   (true_htickcmp0[`TLU_ASR_DATA_WIDTH-2:0]),
    .clk (htcmp0_clk),
    .se  (se),       
...
// THREAD1
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_ASR_DATA_WIDTH-1) htickcmp1 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
...
`else
dff #(`TLU_ASR_DATA_WIDTH-1) htickcmp1 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
	.q   (true_htickcmp1[`TLU_ASR_DATA_WIDTH-2:0]),
    .clk (htcmp1_clk),
    .se  (se),       
...
// THREAD2
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_ASR_DATA_WIDTH-1) htickcmp2 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
...
`else
dff #(`TLU_ASR_DATA_WIDTH-1) htickcmp2 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
	.q   (true_htickcmp2[`TLU_ASR_DATA_WIDTH-2:0]),
    .clk (htcmp2_clk),
    .se  (se),
...
// THREAD3
`ifdef FPGA_SYN_CLK_DFF
dffe #(`TLU_ASR_DATA_WIDTH-1) htickcmp3 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
...
`else
dff #(`TLU_ASR_DATA_WIDTH-1) htickcmp3 (
    .din (tlu_wsr_data_w[`TLU_ASR_DATA_WIDTH-2:0]),
	.q   (true_htickcmp3[`TLU_ASR_DATA_WIDTH-2:0]),
    .clk (htcmp3_clk),
    .se  (se),       
...
dff #(`WSR_PSTATE_VR_WIDTH) dff_dnrtry_pstate_m (
...
dff #(`WSR_PSTATE_VR_WIDTH) dff_pstate_g (
...
dff #(`WSR_PSTATE_VR_WIDTH) dff_pstate_w2 (
...
dff #(`TSA_HTSTATE_WIDTH) dff_tsa_dnrtry_hpstate_m (
...
dff #(`TSA_HTSTATE_WIDTH) dff_tsa_dnrtry_hpstate_g (
...
// 
// added for timing
dff #(`TSA_HTSTATE_WIDTH) dff_tsa_dnrtry_hpstate_w2 (
...
dff #(`TSA_GLOBAL_WIDTH) dff_dnrtry_global_m (
...
dff #(`TSA_GLOBAL_WIDTH) dff_global_g (
...
`ifdef FPGA_SYN_CLK_DFF
dffe #(`WSR_PSTATE_VR_WIDTH-1) dff_restore_pstate0_w3 (
...
`else
dff #(`WSR_PSTATE_VR_WIDTH-1) dff_restore_pstate0_w3 (
    .din ({restore_pstate0[`WSR_PSTATE_VRANGE2_HI:`WSR_PSTATE_VRANGE1_HI-1], 
           restore_pstate0[`WSR_PSTATE_VRANGE1_LO]}), 
    .q   ({restore_pstate0_w3[`WSR_PSTATE_VRANGE2_HI:`WSR_PSTATE_VRANGE1_HI-1],
           restore_pstate0_w3[`WSR_PSTATE_VRANGE1_LO]}),
...
`else
dffr #(2) dffr_true_hpst0_enb_ibe (
    .din (restore_hpstate0[`TLU_HPSTATE_WIDTH-1:`TLU_HPSTATE_WIDTH-2]),
	.q   (true_hpstate0[`TLU_HPSTATE_WIDTH-1:`TLU_HPSTATE_WIDTH-2]),
    .rst (local_rst),
    .clk (hpstate0_clk),
...
`ifdef FPGA_SYN_CLK_DFF
dffe #(`WSR_PSTATE_VR_WIDTH-1) dff_restore_pstate1_w3 (
...
`else
dff #(`WSR_PSTATE_VR_WIDTH-1) dff_restore_pstate1_w3 (
    .din ({restore_pstate1[`WSR_PSTATE_VRANGE2_HI:`WSR_PSTATE_VRANGE1_HI-1], 
           restore_pstate1[`WSR_PSTATE_VRANGE1_LO]}), 
    .q   ({restore_pstate1_w3[`WSR_PSTATE_VRANGE2_HI:`WSR_PSTATE_VRANGE1_HI-1],
           restore_pstate1_w3[`WSR_PSTATE_VRANGE1_LO]}),
...
`else
dffr #(2) dffr_true_hpst1_enb_ibe (
    .din (restore_hpstate1[`TLU_HPSTATE_WIDTH-1:`TLU_HPSTATE_WIDTH-2]),
	.q   (true_hpstate1[`TLU_HPSTATE_WIDTH-1:`TLU_HPSTATE_WIDTH-2]),
    .rst (local_rst),
    .clk (hpstate1_clk),
...
`ifdef FPGA_SYN_CLK_DFF
dffe #(`WSR_PSTATE_VR_WIDTH-1) dff_restore_pstate2_w3 (
...
`else
dff #(`WSR_PSTATE_VR_WIDTH-1) dff_restore_pstate2_w3 (
    .din ({restore_pstate2[`WSR_PSTATE_VRANGE2_HI:`WSR_PSTATE_VRANGE1_HI-1], 
           restore_pstate2[`WSR_PSTATE_VRANGE1_LO]}), 
    .q   ({restore_pstate2_w3[`WSR_PSTATE_VRANGE2_HI:`WSR_PSTATE_VRANGE1_HI-1],
           restore_pstate2_w3[`WSR_PSTATE_VRANGE1_LO]}),
...
`else
dffr #(2) dffr_true_hpst2_enb_ibe (
    .din (restore_hpstate2[`TLU_HPSTATE_WIDTH-1:`TLU_HPSTATE_WIDTH-2]),
	.q   (true_hpstate2[`TLU_HPSTATE_WIDTH-1:`TLU_HPSTATE_WIDTH-2]),
    .rst (local_rst),
    .clk (hpstate2_clk),
...
`ifdef FPGA_SYN_CLK_DFF
dffe #(`WSR_PSTATE_VR_WIDTH-1) dff_restore_pstate3_w3 (
...
`else
dff #(`WSR_PSTATE_VR_WIDTH-1) dff_restore_pstate3_w3 (
    .din ({restore_pstate3[`WSR_PSTATE_VRANGE2_HI:`WSR_PSTATE_VRANGE1_HI-1], 
           restore_pstate3[`WSR_PSTATE_VRANGE1_LO]}), 
    .q   ({restore_pstate3_w3[`WSR_PSTATE_VRANGE2_HI:`WSR_PSTATE_VRANGE1_HI-1],
           restore_pstate3_w3[`WSR_PSTATE_VRANGE1_LO]}),
...
`else
dffr #(2) dffr_true_hpst3_enb_ibe (
    .din (restore_hpstate3[`TLU_HPSTATE_WIDTH-1:`TLU_HPSTATE_WIDTH-2]), 
	.q   (true_hpstate3[`TLU_HPSTATE_WIDTH-1:`TLU_HPSTATE_WIDTH-2]),
    .rst (local_rst),
    .clk (hpstate3_clk),
...
//
// added for timing
dff #(`TLU_ASR_DATA_WIDTH) dff_tlu_exu_rsr_data_m (
