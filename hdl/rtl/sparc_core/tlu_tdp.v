...
// modified for timing: tlu_thrd_wsel_g -> tlu_thrd_wsel_w2
   ...
   assign trap_tsa_wdata[136-1:0] = trap0_tsa_wdata[136-1:0];
...
// recoded due to one-hot problem during reset
   ...
   assign sftint[17-1:0] = sftint0[17-1:0];
...
*/
   ...
   assign      sftint_rdata[16:0] = sftint0[17-1:0];
...
wire [34-1:0] htba_rdata;
   ...
   assign 		   htba_rdata[34-1:0] = true_htba0[34-1:0];
   assign 		   htba_data[34-1:0] = true_htba0[34-1:0];
...
// and thus needs separate mux
   ...
   assign tickcmp_data[64-4:0] = true_tickcmp0[64-2:2];
   assign tickcmp_rdata[64-1:0] = true_tickcmp0[64-1:0];
...
// and thus needs separate mux
   ...
   assign stickcmp_data[64-4:0] = true_stickcmp0[64-2:2];
   assign stickcmp_rdata[64-1:0] = true_stickcmp0[64-1:0];
...
// and thus needs separate mux
   ...
   assign htickcmp_data[64-4:0] = true_htickcmp0[64-2:2];
   assign htickcmp_rdata[64-2:0] = true_htickcmp0[64-2:0];
...
//
   ...
   assign tdp_sscan_test_data[51-1:0] = sscan_data_test0[51-1:0];
...
wire [12-1:0] hpstate_rdata;
   ...
   assign       pstate_rdata[12-1:0] = true_pstate0[12-1:0];
   assign 	true_hpstate[5-1:0] = true_hpstate0[5-1:0];
...
// mux data width - 2b
   ...
   assign global_rdata[2-1:0] = tlu_gl_lvl0[2-1:0];
