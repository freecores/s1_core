...
//
dff #(`TLU_ASR_DATA_WIDTH) dff_tlu_wsr_data_w (
...
dff #(`TLU_ASR_ADDR_WIDTH) dff_pib_sraddr_e (
...
dffre #(`PIB_PCR_WIDTH-2) dffre_pcr0 (
...
dffre #(`PIB_PCR_WIDTH-2) dffre_pcr1 (
 //   .din (tlu_wsr_data_w[`PIB_PCR_WIDTH-1:0]),
    .din (pcr_wdata_in[`PIB_PCR_WIDTH-3:0]),
...
dffre #(`PIB_PCR_WIDTH-2) dffre_pcr2 (
 //   .din (tlu_wsr_data_w[`PIB_PCR_WIDTH-1:0]),
    .din (pcr_wdata_in[`PIB_PCR_WIDTH-3:0]),
...
dffre #(`PIB_PCR_WIDTH-2) dffre_pcr3 (
 //   .din (tlu_wsr_data_w[`PIB_PCR_WIDTH-1:0]),
    .din (pcr_wdata_in[`PIB_PCR_WIDTH-3:0]),
...
//
// added for timing
dff #(`TLU_THRD_NUM) dff_pic_cnt_en_w2 (
...
dffe #(`PIB_EVQ_CNT_WIDTH) dff_picl_evq0 (
...
dffe #(`PIB_EVQ_CNT_WIDTH) dff_picl_evq1 (
...
dffe #(`PIB_EVQ_CNT_WIDTH) dff_picl_evq2 (
...
dffe #(`PIB_EVQ_CNT_WIDTH) dff_picl_evq3 (
...
dffe #(`PIB_PIC_CNT_WIDTH) dff_picl_cnt0 (
...
dffe #(`PIB_PIC_CNT_WIDTH) dff_picl_cnt1 (
...
dffe #(`PIB_PIC_CNT_WIDTH) dff_picl_cnt2 (
...
dffe #(`PIB_PIC_CNT_WIDTH) dff_picl_cnt3 (
...
//==================================================================
//
dffr #(`TLU_THRD_NUM) dffr_inst_vld_w2 (
...
//
dff #(`TLU_THRD_NUM) dff_pich_fourbelow_flg (
...
dffe #(`PIB_PIC_CNT_WIDTH) dff_pich_cnt0 (
...
dffe #(`PIB_PIC_CNT_WIDTH) dff_pich_cnt1 (
...
dffe #(`PIB_PIC_CNT_WIDTH) dff_pich_cnt2 (
...
dffe #(`PIB_PIC_CNT_WIDTH) dff_pich_cnt3 (
...
//
dff #(`TLU_THRD_NUM-1) dff_thread_rsel_e (
